        ...
        if ('object' == typeof obj[key])
            ...
            -1 === window.location.href.indexOf('/modules/') && (href = 'modules/'),
                (window.location.href.indexOf('/assets/') > -1 ||
                    ...
                    (href = '../modules/'),
                window.location.href.indexOf('/modules/') > -1 && (href = '../modules/' + href),
                (href += package
                    ? 'Overview' === key
...
function renderHTMLRecursive(obj, package, spacing) {
    ...
    for (var html = '', shownPackages = [], _i = 0, _a = Object.keys(obj); _i < _a.length; _i++) {
        var key = _a[_i];
        if ('object' == typeof obj[key]) html += renderHTMLRecursive(obj[key], package + '_' + key, spacing + '&emsp;');
        else {
            -1 === shownPackages.indexOf(package) &&
                ((html += '<div>' + package.replace(/_/g, '/').substr(1) + '</div>'), shownPackages.push(package));
            var href = '';
        ...
        var t = (function (a) {
            function fb(a, b, d, e) {
                ...
                if (p && !e) {
                    ...
                    if (c.qsa && (!q || !q.test(a))) {
                        if (
                            ((s = r = u), (w = b), (x = 9 === k && a), 1 === k && 'object' !== b.nodeName.toLowerCase())
                        ) {
                            for (
                                o = g(a),
        ...
        n.fn.extend({
            ...
            n.each(n.expr.match.bool.source.match(/\w+/g), function (a, b) {
                ...
                $b[b] = function (a, b, d) {
                    var e, f;
                    return (
                        d || ((f = $b[b]), ($b[b] = e), (e = null != c(a, b, d) ? b.toLowerCase() : null), ($b[b] = f)),
                        e
                    );
                };
            });
    ...
    function () {
        ...
        var A = (j.each = j.forEach = function (n, t, e) {
            ...
            if (s && n.forEach === s) n.forEach(t, e);
                ...
                for (var a = j.keys(n), u = 0, i = a.length; i > u; u++) if (t.call(e, n[a[u]], a[u], n) === r) return;
            return n;
        });
...
!(function (typedoc) {
    ...
    window.addEventListener('load', function () {
        if (document.querySelector('.tsd-navigation.outline')) {
            ...
            (outlineElement.innerHTML = renderHTMLRecursive(outline)), (outlineElement.style.display = 'block');
        } else {
            ...
            document.querySelector('.tsd-navigation ul').innerHTML += renderSimpleHTMLRecursive(hierarchy_1);
        }
    });
var typedoc;
!(function (typedoc) {
    !(function (search) {
        ...
        function loadIndex() {
            if (loadingState == SearchLoadingState.Idle && !search.data) {
                setTimeout(function () {
                    loadingState == SearchLoadingState.Idle && setLoadingState(SearchLoadingState.Loading);
                }, 500);
                var url = $el.attr('data-index');
                if (!url) return void setLoadingState(SearchLoadingState.Failure);
                fetch(url)
        ...
        function updateResults() {
            ...
            if (loadingState === SearchLoadingState.Ready) {
                ...
                for (var res = index.search(query), i = 0, c = Math.min(10, res.length); i < c; i++) {
                    ...
                    row.parent && (name_1 = '<span class="parent">' + row.parent + '.</span>' + name_1);
...
!(function (typedoc) {
    ...
    (typedoc.transition = (function (tuples) {
        for (var name_2 in tuples)
            if (tuples.hasOwnProperty(name_2) && void 0 !== document.body.style[name_2])
